...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao MultiZap SaaS 2.0V, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [1] Instalar MultiZap SaaS 2.0V \n"
  # printf "   [1] Atualizar MultiZap SaaS 2.0V\n"
  printf "   [2] Deletar MultiZap SaaS 2.0V \n"
  printf "   [3] Bloquear MultiZap SaaS 2.0V \n"
  printf "   [4] Desbloquear MultiZap SaaS 2.0V \n"
  printf "   [5] Alter. dominio MultiZap SaaS 2.0V \n"
  printf "\n"
  read -p "> " option
